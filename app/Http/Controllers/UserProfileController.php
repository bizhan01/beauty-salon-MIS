...
class UserProfileController extends Controller {
    ...
    public function profile() {
      ...
      $products = DB::table('products')->where('user_id', $userid)->latest()->get();
      $posts = DB::table('posts')->where('user_id', $userid)->latest()->get();
      $advertisements = DB::table('advertisements')->where('user_id', $userid)->latest()->get();
    	return view('systemUsers.profile.profile', compact('services', 'products', 'posts', 'advertisements'));
    }

      ...
      <div class="col-md-8">
        <div style="margin-bottom: -50px">
          <ul class="  nav nav-tabs" role="tablist" style="background-color: #d9dee6; padding: 5px">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#tab-2" role="tab">خدمات</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#tab-3" role="tab">محصولات</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#tab-4" role="tab">جستجو</a>
            </li>
            <li class="nav-item">
